...
type Origin = 'top-left' | 'top-right' | 'left' | 'right' | 'bottom-left' | 'bottom-center' | 'bottom-right' | 'top-center';
      ...
      cleanupFunctionRef.current = () => {
        ...
        if (renderer) {
          try {
            ...
            const loseContextExt = (renderer.gl as any).getExtension('WEBGL_lose_context');
